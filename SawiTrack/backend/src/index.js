...
// MANUAL CORS MIDDLEWARE (Debug Mode & Strict)
app.use((req, res, next) => {
  const origin = req.headers.origin;
  const allowed = ["https://palmaroots.my.id", "https://www.palmaroots.my.id"];
  
  // Debug header to prove this code is running
  res.setHeader("X-CORS-Debug", "Active");
...
console.log("Manual CORS Middleware Applied (Debug Mode).");
